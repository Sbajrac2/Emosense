...
export const IMAGES = {
    ...
    emoji_happy: require('../../assets/images/5.png'),
    emoji_tired: require('../../assets/images/6.png'),
  
    // People/photos
    photo_girl: require('../../assets/images/7.png'),
    photo_boy: require('../../assets/images/8.png'),
    photo_woman: require('../../assets/images/9.png'),
    photo_man: require('../../assets/images/10.png'),
  
    // Summary / badges / avatar
